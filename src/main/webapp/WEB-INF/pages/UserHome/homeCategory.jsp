    ...
    <div class="d-flex justify-content-center" style="margin-top:19px;">
     ...
     <c:forEach var="products" items="${productList}">
      <div class="card" style="width: 18rem;" >
        <img src="/user/getProductPhoto/<c:out value='${products.productId}'/>" class="card-img-top" alt="..." onClick="window.location.href='/user/getDetail/${products.productId}'">
        <div class="card-body">
          <h5 class="text-center fs-2">${products.productName}</h5>
            <div class="d-flex justify-content-center">
                               <div class="rating" style="display:flex; justify-content:center; width:100%;">
                                <i class="fa fa-star mr-3" style="color: #FFD43B;"></i>
                                <i class="fa fa-star mr-3" style="color: #FFD43B;"></i>
                                <i class="fa fa-star mr-3" style="color: #FFD43B;"></i>
                                <i class="fa fa-star mr-3" style="color: #FFD43B;"></i>
          ...
          <p class="text-center fs-5 mt-1">Price:${products.productPrice}</p>
           <p class="text-center fs-5 ">also ${products.quantity} products</p>
           <div class="d-flex justify-content-center">
                 <button class="btn btn-success" onClick="window.location.href='/user/addToCart/${products.productId}'">
